...
export const Sidebar = () => {
    return (
        <aside className="w-80 rounded-2xl relative bg-white ">
            ...
            <nav style={{ fontFamily: 'General Sans, sans-serif' }} className="p-4 space-y-3">
                {menuItems.map((item) => (
...
const MenuItem = ({
    ...
    const content = (
        <div
            className={`flex items-center space-x-3 px-4 py-3 rounded-lg ${active ? "bg-[#eeffe0]" : "text-gray-700 hover:bg-gray-100"
                }`}
        >
            <Image
                src={icon}
