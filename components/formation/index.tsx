...
export default function Students() {
 const [students, setStudents] = useState<Formation[]>([]);
 const [loading, setLoading] = useState(false);
 const [error, setError] = useState<string | null>(null);
 const [searchTerm, setSearchTerm] = useState("");
 const [selectedStatus, setSelectedStatus] = useState<FormationStatus | "All">(
  "All"
 );
 ...
 useEffect(() => {
  const fetchFormation = async () => {
   ...
   try {
    ...
    if (!res.ok) throw new Error(`Error fetching formation: ${res.statusText}`);
 ...
 const handleEditStudent = (student: Formation) => {
  console.log("Edit student:", student);
  // Implement edit logic
 };

 const handleToggleStatus = (student: Formation) => {
  console.log("Toggle status for student:", student);
  // Implement status toggle logic
 };

 const handleViewDetails = (student: Formation) => {
